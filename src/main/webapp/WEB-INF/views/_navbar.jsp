...
<aside class="col-md-3 mb-md-0 mb-3">
  <nav class="list-group">
    <a class="list-group-item ${requestScope.screen =='account' ? 'active' : ''}"
    ...
    <c:choose>
      <c:when test="${requestScope.screen == 'change_pass'}">
        <a class="list-group-item active" href="${pageContext.request.contextPath}/changePassword"> Đổi mật khẩu </a>
      </c:when>
      <c:otherwise>
        <a class="list-group-item" href="${pageContext.request.contextPath}/changePassword"> Đổi mật khẩu </a>
      </c:otherwise>
    </c:choose>
    <c:choose>
      ...
      <c:otherwise>
        <a class="list-group-item" href="${pageContext.request.contextPath}/setting"> Thiết đặt </a>
      </c:otherwise>
    </c:choose>
