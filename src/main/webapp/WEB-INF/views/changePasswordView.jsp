...
<section class="section-content padding-y">
  ...
  <c:when test="${empty sessionScope.currentUser}">
    <p>
      Vui lòng <a href="${pageContext.request.contextPath}/changepassword">đăng nhập</a> để xem thông tin tài khoản.
    </p>
  </c:when>
  <c:otherwise>
      <aside class="col-md-3 mb-md-0 mb-3">
        <nav class="list-group">
          ...
          <a class="list-group-item active" href="${pageContext.request.contextPath}/changepassword" role="button"> Đổi mật khẩu </a>
